...
foreach ($agent->stream($message, $context) as $chunk) {
    echo $chunk; // Display to user in real-time
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <a href="{{ route('developers.api-docs') }}" class="text-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    ...
                    <a href="{{ route('developers.sdks') }}" class="text-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                        <svg class="w-12 h-12 text-purple-600 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('support.guides') }}" class="text-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                        <svg class="w-12 h-12 text-purple-600 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
