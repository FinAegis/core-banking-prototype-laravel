        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-10 md:flex md:space-x-8">
                    ...
                    <a href="{{ route('ai-framework') }}" class="text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium {{ request()->routeIs('ai-framework*') ? 'text-indigo-600 border-b-2 border-indigo-600' : '' }}">AI Framework</a>
