            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-purple-900 rounded-lg font-semibold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg">
                            Open GCU Account
                        </a>
                        <a href="#composition" class="inline-flex items-center justify-center px-8 py-4 bg-purple-800 text-white rounded-lg font-semibold hover:bg-purple-700 transition-all">
                            View Composition
                        </a>
                    </div>
    ...
    <section class="py-20 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 text-white">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('support.contact') }}" class="inline-flex items-center justify-center px-8 py-4 bg-purple-800 text-white rounded-lg font-semibold hover:bg-purple-700 transition-all">
                    Contact Sales
                </a>
            </div>
        </div>
