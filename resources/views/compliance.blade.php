    ...
    <div class="bg-white">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="mt-6 text-xl text-blue-100 max-w-3xl mx-auto">
                        Built on EU regulatory standards with Lithuanian EMI licensing, enabling compliant operations across 27 European countries through passport rights.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900">EU-First Regulatory Strategy</h2>
                <p class="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                    Licensed through Bank of Lithuania's Electronic Money Institution (EMI) framework, providing full European Union market access with regulatory passport rights.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition duration-200">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">PSD2 Compliance</h3>
                    <p class="text-gray-600 mb-4">Payment Services Directive 2 compliant for all payment operations and account services.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition duration-200">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">EMD2 Framework</h3>
                    <p class="text-gray-600 mb-4">Electronic Money Directive 2 authorization for e-money issuance and management.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
                        <li>• €350K minimum capital requirement</li>
                        <li>• Safeguarding of customer funds</li>
                        <li>• E-money redemption guarantees</li>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition duration-200">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">MiCA Prepared</h3>
                    <p class="text-gray-600 mb-4">Markets in Crypto-Assets ready infrastructure for digital asset operations.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
            ...
            <div class="bg-gray-50 rounded-lg p-8 mb-16">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Multi-Tier KYC Verification System</h3>
            ...
            <!-- Banking Partners -->
            <div class="bg-gray-50 rounded-lg p-8 mb-16">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Licensed Banking Partners</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    
                    <!-- Paysera -->
                    <div class="bg-white rounded-lg p-6 border border-gray-200">
                        <h4 class="font-semibold text-gray-900 mb-2">Paysera LT UAB</h4>
                        <p class="text-sm text-gray-600 mb-3">Primary EMI Partner</p>
                        <ul class="text-xs text-gray-500 space-y-1">
                            <li>• Lithuanian EMI License</li>
                            <li>• EU Passport Rights</li>
                            <li>• €100K deposit guarantee</li>
                    ...
                    <!-- Deutsche Bank -->
                    <div class="bg-white rounded-lg p-6 border border-gray-200">
                        <h4 class="font-semibold text-gray-900 mb-2">Deutsche Bank</h4>
                        <p class="text-sm text-gray-600 mb-3">Global Banking Partner</p>
                        <ul class="text-xs text-gray-500 space-y-1">
                            <li>• German Banking License</li>
                            <li>• Global presence</li>
                            <li>• Basel III compliant</li>
                            <li>• SEPA Instant ready</li>
                        </ul>
                    </div>

                    <!-- Santander -->
                    <div class="bg-white rounded-lg p-6 border border-gray-200">
                        <h4 class="font-semibold text-gray-900 mb-2">Santander</h4>
                        <p class="text-sm text-gray-600 mb-3">European Coverage</p>
                        <ul class="text-xs text-gray-500 space-y-1">
                            <li>• Spanish Banking License</li>
                            <li>• EU-wide operations</li>
                    ...
                    <!-- Wise -->
                    <div class="bg-white rounded-lg p-6 border border-gray-200">
                        <h4 class="font-semibold text-gray-900 mb-2">Wise</h4>
                        <p class="text-sm text-gray-600 mb-3">Digital Banking</p>
                        <ul class="text-xs text-gray-500 space-y-1">
                            <li>• UK EMI License</li>
                            <li>• Multi-currency support</li>
                            <li>• API-first platform</li>
            ...
            <!-- Security Standards -->
            <div class="bg-white border border-gray-200 rounded-lg p-8 mb-16">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Security & Technical Standards</h3>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div class="text-center">
                        <div class="text-lg font-semibold text-gray-900">ISO 27001</div>
                        <div class="text-sm text-gray-600">Information Security</div>
                    </div>
                    <div class="text-center">
                        <div class="text-lg font-semibold text-gray-900">SOC 2 Type II</div>
                        <div class="text-sm text-gray-600">Service Controls</div>
                    </div>
                    <div class="text-center">
                        <div class="text-lg font-semibold text-gray-900">PCI DSS</div>
                        <div class="text-sm text-gray-600">Card Data Security</div>
                    </div>
                    <div class="text-center">
                        <div class="text-lg font-semibold text-gray-900">SHA3-512</div>
                        <div class="text-sm text-gray-600">Quantum-Resistant</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 text-white mb-16">
                <h3 class="text-2xl font-bold mb-6">Real-Time Compliance Monitoring</h3>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div class="text-center">
                        <div class="text-3xl font-bold mb-2">99.99%</div>
                        <div class="text-blue-100">Transaction Monitoring</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold mb-2">&lt;100ms</div>
                        <div class="text-blue-100">Risk Assessment</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold mb-2">24/7</div>
                        <div class="text-blue-100">Compliance Team</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold mb-2">2 years</div>
                        <div class="text-blue-100">KYC Review Cycle</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Compliance & Regulatory Inquiries</h3>
