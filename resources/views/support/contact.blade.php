        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="text-center">
                    ...
                    <a href="mailto:alpha@finaegis.com" class="text-indigo-600 hover:text-indigo-700 font-medium">alpha@finaegis.com</a>
                </div>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <form method="POST" action="#" class="space-y-6" onsubmit="alert('Form submission is not active during alpha testing. Please email alpha@finaegis.com'); return false;">
                        @csrf
                ...
                <div class="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4">
                    <p class="text-amber-800 text-center">
                        ...
                        <span class="font-semibold">Alpha Testing:</span> Form submission is currently disabled. Please email us directly at alpha@finaegis.com
                    </p>
                </div>
            </div>
        </div>
